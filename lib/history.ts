...
// Dates verified against gekko project memory (gekko-weekendN-done.md, each stamped
// "Weekend N completed YYYY-MM-DD"). The entire build ran 2026-05-27 → 2026-06-30 —
// the "weekends" are rapid build-sprints, not calendar weeks. Do not hand-edit dates;
// they are sourced from memory.
